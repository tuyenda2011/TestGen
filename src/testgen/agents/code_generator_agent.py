...
def heal_pytest_code(
    ...
    system_prompt = (
        ...
        "4. Do not add new tests during heal mode unless the existing file would otherwise become invalid.\n"
